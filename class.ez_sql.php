<?php
  ...
  // ==================================================================
  //  Author: Justin Vincent (justinvisunet.ie)
  ...
  //	     by Michael Paesold (mpaesoldgmx.at).
  //       and then reworked to act more like mysql version by
  //       Tom De Bruyne (tommorefast.be)
  //
  // !! IMPORTANT !!
  //
  //  Please send me a mail telling me what you think of ezSQL
  //  and what your using it for!! Cheers. [ justinvisunet.ie ]
  //
  // ==================================================================
  ...
  class db {
    private $debug_called;
    private $vardump_called;
    ...
    function print_error($str = "")
    {
      ...
      if ( $this->show_errors )
      {
        ...
        print "[<font color=000077>$str</font> ($this->last_query)]";
...
// $db = new db("pguser", '', "pgdb", "localhost");
?>