...
This little project started when I upgraded the server hosting a very important PHP4 application of mine to Apache2 and PHP5, resulting in the complete breakage of the database abtraction class being used: ezSQL version 1.26. The problem was that the PosgreSQL implementation of the ezSQL 1.26 class was incompatible with the object model of PHP5.
...
This fork has been successfully tested on Ubuntu 6.06 with it's default package of PHP 5.1.2 and on Ubuntu 8.04 with PHP 5.2.4. Both running PostgreSQL 8.1.x.
